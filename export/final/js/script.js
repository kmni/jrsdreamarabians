...
!function(){$("#facebook").length&&Social.facebook("405209389537340","392120024178056|aqQUlwOblkyuLzKmxZm39SeBVck")}();
var $doc=$(document),$window=$(window),mobileBreakpoint=768,mobile=!1;$doc.width()<=mobileBreakpoint&&(mobile=!0),$window.resize(function(){mobile=$doc.width()<=mobileBreakpoint?!0:!1}),function(){$(".jsGallery").each(function(){$(this).magnificPopup({delegate:"a",type:"image",tLoading:"Nahrávám…",tClose:"Zavřít",showCloseBtn:!0,gallery:{enabled:!0,tPrev:"Předchozí",tNext:"Další",tCounter:"%curr% z %total%"},image:{tError:"<a href='%url%'>Obrázek</a> se nepodařilo nahrát."}})}),$(".jsPopup").each(function(){var a=$(this),b=$("."+a.data("box"));a.magnificPopup({type:"inline",items:{src:b},fixedContentPos:!0,showCloseBtn:!1})}),$(".jsPopupBox").find(".close, .closeButton").click(function(){$.magnificPopup.close()})}(),$window.resize(),$doc.scroll();